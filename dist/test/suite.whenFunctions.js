...
class SuiteWhenFunctions {
    controller({ testAll }) {
        return testAll(new dataTypes_1.DataTypes());
    }
    whenObjectLike({ expect, spotlight, beforeThrowing, tagger }, types) {
        const tags = tagger();
...
exports.SuiteWhenFunctions = SuiteWhenFunctions;
//# sourceMappingURL=suite.whenFunctions.js.map