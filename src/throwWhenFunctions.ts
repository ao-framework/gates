 ...
 * @param errorConstructor
 */
export function throwWhenObjectLike<Context>(
  variable: Context,
  message: string,
 ...
 * @param errorConstructor
 */
export function throwWhenObject<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenString<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenStringWithLength<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenFunction<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenBoolean<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNumber<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenArray<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenUndefined<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNull<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNill<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenBigInt<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenSymbol<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenTrue<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
