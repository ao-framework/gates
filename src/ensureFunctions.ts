...
export function ensureObject<Context extends object>(variable: Context, defaultObject: Context, merge: boolean = true) {
  return isObject(variable) ? (merge ? Object.assign(defaultObject, variable) : variable) : defaultObject
}
 ...
 * @param merge
 */
export function ensureArray<Context extends Array<unknown>>(
  variable: Context,
  defaultArray: Context,
  merge: boolean = true
) {
  return isArray(variable) ? (merge ? Object.assign(defaultArray, variable) : variable) : defaultArray
}
 ...
 * @param variable
 */
export function ensureFunction(variable: unknown) {
