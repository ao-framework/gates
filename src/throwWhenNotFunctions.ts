 ...
 */
export function throwWhenNotObjectLike<Context>(
  variable: Context,
  message: string,
 ...
 * @param errorConstructor
 */
export function throwWhenNotObject<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotString<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotStringWithLength<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotFunction<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotBoolean<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotNumber<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotArray<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotUndefined<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotNull<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotNill<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotBigInt<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenNotSymbol<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
 ...
 * @param errorConstructor
 */
export function throwWhenFalse<Context>(
  variable: Context,
  message: string,
  errorConstructor: ErrorConstructor = Error
): Context {
